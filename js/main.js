...
function detectChange() {
    ...
    let selectDoctor = document.getElementById("test008")
    selectDoctor .innerHTML = '<?php echo "<option selected>Select Doctor</option>"';

    /*selectDoctor.innerHTML = '<option selected>Select Doctor</option>' +
    '<?php' +
    'echo "test here";' +
...
(function ($) {
  ...
  // create event listener on select option change
